...
object THREE extends js.Object {
  ...
  class PerspectiveCamera(
    ...
    def setLens(focalLength: Double, frameHeight: Double = js.native): Unit =
      js.native
    def setViewOffset(
        fullWidth: Double,
        fullHeight: Double,
  ...
  @js.native
  class BufferAttribute(var array: js.Any, var itemSize: Double)
      extends js.Object {
  ...
  class Geometry extends js.Object with EventDispatcher {
    ...
    def computeVertexNormals(areaWeighted: Boolean = js.native): Unit =
      js.native
  ...
  @js.native
  class BufferGeometryLoader(manager: LoadingManager = js.native)
      extends js.Object {
    def load(
        url: String,
  ...
  class JSONLoader(showStatus: Boolean = js.native) extends Loader {
    ...
    def load(
        url: String,
        callback: js.Function2[JSonLoaderResultGeometry, js.Array[
          Material
        ], Unit],
  ...
  class MeshLambertMaterial(
      parameters: MeshLambertMaterialParameters = js.native
  ) extends Material {
    var color: Color = js.native
  ...
  class SpriteCanvasMaterial(
      parameters: SpriteCanvasMaterialParameters = js.native
  ) extends Material {
    var color: Color = js.native
  ...
  class Box2(var min: Vector2 = js.native, var max: Vector2 = js.native)
    ...
    def clampPoint(
        point: Vector2,
        optionalTarget: Vector2 = js.native
    ): Vector2 = js.native
  ...
  class Euler(
    ...
    def setFromRotationMatrix(m: Matrix4, order: String = js.native): Euler =
      js.native
  ...
  class Line3(var start: Vector3 = js.native, var end: Vector3 = js.native)
      extends js.Object {
    def set(start: Vector3 = js.native, end: Vector3 = js.native): Line3 =
      js.native
  ...
  trait Matrix extends js.Object {
    ...
    def getInverse(
        matrix: Matrix,
        throwOnInvertible: Boolean = js.native
    ): Matrix = js.native
  ...
  class Plane(var normal: Vector3 = js.native, var constant: Double = js.native)
    ...
    def applyMatrix4(
        matrix: Matrix4,
        optionalNormalMatrix: Matrix3 = js.native
    ): Plane = js.native
  ...
  class Quaternion(
    ...
    def setFromEuler(euler: Euler, update: Boolean = js.native): Quaternion =
      js.native
  ...
  class Ray(var origin: Vector3 = js.native, var direction: Vector3 = js.native)
    ...
    def isIntersectionBox(box: Box3): Boolean = js.native
    def intersectBox(box: Box3, optionalTarget: Vector3 = js.native): Vector3 =
      js.native
  ...
  @js.native
  class Vector2(var x: Double = js.native, var y: Double = js.native)
      extends Vector {
  ...
  class LOD extends Object3D {
    ...
    def addLevel(`object`: Object3D, distance: Double = js.native): Unit =
      js.native
  ...
  class PointCloud(
      ...
      var material: PointCloudMaterial = js.native
  ) extends Object3D {
  ...
  @js.native
  class CanvasRenderer(parameters: CanvasRendererParameters = js.native)
      extends Renderer {
    ...
    def setClearColor(color: Color, opacity: Double = js.native): Unit =
      js.native
    def setClearColorHex(hex: Double, alpha: Double = js.native): Unit =
      js.native
  ...
  @js.native
  class WebGLRenderer(parameters: WebGLRendererParameters = js.native)
      extends Renderer {
  ...
  @js.native
  class WebGLShader(gl: js.Any, `type`: String, string: String)
      extends js.Object
  ...
  class Scene extends Object3D {
    ...
    def add(g: Group): Unit = js.native
  }
  ...
  object FontUtils extends js.Object {
    ...
    def generateShapes(
        text: String,
        parameters: js.Any = js.native
    ): js.Array[Shape] = js.native
  ...
  class Animation(var root: Mesh, var data: AnimationData) extends js.Object {
    ...
    def play(startTime: Double = js.native, weight: Double = js.native): Unit =
      js.native
    def stop(): Unit = js.native
  ...
  object Curve extends js.Object {
    ...
    def create(
        constructorFunc: js.Function,
        getPointFunc: js.Function
  ...
  @js.native
  class ClosedSplineCurve3(var points: js.Array[Vector3] = js.native)
      extends Curve {
  ...
  @js.native
  class BoundingBoxHelper(var `object`: Object3D, hex: Double = js.native)
      extends Mesh {
  ...
  @js.native
  class PointLightHelper(var light: Light, sphereSize: Double)
      extends Object3D {
    def dispose(): Unit = js.native
    def update(): Unit = js.native
  }
  ...
  @js.native
  class WireframeHelper(`object`: Object3D, hex: Double = js.native)
      extends Line
  ...
  class Group extends js.Object {
    ...
    def add(mesh: Mesh): Unit = js.native
  }
